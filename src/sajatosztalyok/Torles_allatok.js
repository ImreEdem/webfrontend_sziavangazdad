      ...
      {isLoading ? (
        ...
        <FlatList
          ...
          renderItem={({item}) => (
            ...
            <Image source={{ uri: "http://nodejs2.dszcbaross.edu.hu:22004/kepek/"+item.allatok_kep }} style={{ width: 300, height: 300, margin: 'auto', borderWidth: 4, borderColor: 'blue', borderRadius: 3 }} />
            </View>
        ...
        onPress={async ()=>torles(item.allatok_id)}
      >
